...
class FilterPostTest extends PHPUnit_Framework_TestCase
{
	protected $filter;
	
	public function setUp()
	{
		$_POST['html_text']		= '<p><strong>Testing</strong></p>';
		$_POST['html_quotes']	= "<p><strong>'Testing'</strong></p>";
		$_POST['number']			= 13;
		$_POST['string_number']	= '13';
		$_POST['valid_email']	= 'myemail@mydomain.ltd';
		$_POST['invalid_email']	= 'myemail@mydomain.lt;d';

		$this->filter = new Framfurt\Core\FilterPost();
	}
	...
	{
		$_POST = array();
		$filterget = new Framfurt\Core\FilterPost();
