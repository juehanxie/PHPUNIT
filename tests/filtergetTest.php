...
class FilterTest extends PHPUnit_Framework_TestCase
{
	...
	{
		$_GET['html_text']		= '<p><strong>Testing</strong></p>';
		$_GET['html_quotes']	= "<p><strong>'Testing'</strong></p>";
		$_GET['number']			= 13;
		$_GET['string_number']	= '13';
		$_GET['valid_email']	= 'myemail@mydomain.ltd';
		$_GET['invalid_email']	= 'myemail@mydomain.lt;d';

		$this->filter = new Framfurt\Core\FilterGet();
	}
	...
	{
		$_GET = array();
		$filterget = new Framfurt\Core\FilterGet();
